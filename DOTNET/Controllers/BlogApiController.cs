...
namespace Web.Api.Controllers
{
    ...
    public class BlogApiController : BaseApiController
    {
        ...
        [HttpGet("bydate")]
        [AllowAnonymous]
        public ActionResult<ItemResponse<Paged<Blog>>> PaginationByLatestDate(int pageIndex, int pageSize)
        {
            int code = 200;
            BaseResponse response = null;
            ...
            try
            {
                Paged<Blog> blogPaged = _service.PaginationByLatestDate(pageIndex, pageSize);
