        ...
        <div className="align-self-center w-100">
          ...
          <Table className="mb-0">
            ...
            <tbody>
              <tr>
                <td>
                  <FaSquare className="text-primary" /> Direct
                </td>
              ...
              <tr>
                <td>
                  <FaSquare className="text-warning" /> Affiliate
                </td>
              ...
              <tr>
                <td>
                  <FaSquare className="text-danger" /> E-mail
                </td>
              ...
              <tr>
                <td>
                  <FaSquare className="text-dark" /> Other
                </td>
